...
params = {
    ...
    'plotter': {
        ...
        'v_label_pad': -20,
        'v_limits': [-0.15, 0.25],
        'v_tick_labels': [-0.1, '', '', 0.2],
        'v_ticks': [-0.1, 0.0, 0.1, 0.2],
        'v_ticks_minor': [i * 0.05 - 0.1 for i in range(9)],
        'height': 2.5,
        'width': 2.3,
        'annotations': [{
            's': '(b)',
...
# looper
looper = wrap_looper(SystemClass=BEC_00, params=params, func='transmission_phase', looper='XYZLooper', file_path_prefix='data/bec_00/v0.14/8b')
