...
params = {
    ...
    'plotter': {
        ...
        'x_ticks_minor': [i * 1e-15 for i in range(11)],
        'y_label': '$L_{p}$',
        'y_label_pad': -48,
        'y_tick_labels': [-10, '', '', '', 10],
        'y_tick_pad': 16,
...
# looper
looper = wrap_looper(SystemClass=BEC_10, params=params, func='osz', looper='XYLooper', file_path_prefix='data/v1.1-qom-v0.8.5/2c', plot=True)