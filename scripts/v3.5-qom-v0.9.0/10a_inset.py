...
params = {
    ...
    'plotter': {
        ...
        'y_sizes': [2],
        'v_label': '$\\tau_{g}$ (ms)',
        'v_tick_labels': [i * 20 for i in range(5)],
        'v_ticks': [i * 20e-3 for i in range(5)],
...
if __name__ == '__main__':
    # looper
    looper = run_loopers_in_parallel(SystemClass=BEC_10, params=params, func=func_transmission_phase_norm, looper='XYLooper', file_path_prefix='data/v3.5-qom-v0.9.0/10a_inset')
