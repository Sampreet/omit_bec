...
params = {
    ...
    'plotter': {
        ...
        'y_label': '$L_{p}$',
        'y_tick_pad': 16,
        'y_ticks': [i * 6 for i in range(6)],
        'y_ticks_minor': [i * 2 for i in range(15)],
        'v_ticks': [0, 1, 2, 3],
        'annotations': [{
            's': 's',
            'xy': (0.33, 0.44),
...
if __name__ == '__main__':
    run_loopers_in_parallel(SystemClass=BEC_10, params=params, func='osz', looper='XYLooper', file_path_prefix='data/v3.5-qom-v0.9.0/replies_01_1', plot=True)